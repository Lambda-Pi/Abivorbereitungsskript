...
% Section Begriffe
\input{Chapters/Stochastik/Begriffe.tex}

% Section Mathematische Grundlagen
\input{Chapters/Stochastik/Grundlagen.tex}

% Section Einmaliges Ziehen
\input{Chapters/Stochastik/EinmaligesZiehen.tex}

% Section Mehrmaliges Ziehen
\input{Chapters/Stochastik/MehrmaligesZiehen.tex}

% Section häufiges Ziehen
\input{Chapters/Stochastik/HaeufigesZiehen.tex}

% Section mindestens / höchstens
\input{Chapters/Stochastik/MindestensHoechstens.tex}

% Section einseitiger Signifikanztest
\input{Chapters/Stochastik/Signifikanztest.tex}