\subsection{Rechnen mit Vektoren}
	...
	\subsubsection{Kreuzprodukt}
		...
		\todo[color=purple]{Signalwörter-Kasten hinzufügen}
		\todo[color=green]{Fächeninhalt muss noch rein!}
		...
		\summary{
			Das Kreuzprodukt kann für 2 Sachen genutzt werden:
			\begin{itemize}
			  \item Um einen Vektor zu finden, der Rechtwinklig zu 2 gegebenen liegt
			  (z.B. um den Normalenvektor zu bekommen).
			  \item Den Flächeninhalt von Parallelogrammen und Dreiecken zu berechnen.
			\end{itemize}
		}
